...
* 🎟️ **E-Ticket & QR Code (Paperless):** Tiket digital dengan QR Code unik terbit secara instan sesaat setelah pembayaran sukses.
...
* 🗄️ **Manajemen Master Data (CRUD):** Pengelolaan data PO Bus, Fasilitas, Layout Kursi, pengaturan tarif dasar, dan rute perjalanan.
* 🗓️ **Manajemen Jadwal & Kuota:** Pembuatan jadwal keberangkatan (*Assign Bus to Route*) dan fitur *Block Seat* untuk kebutuhan operasional khusus.
...
### ⚙️ 3. Fitur Backend & Sistem (API Service)
...
* ⏱️ **Auto-Cancel Scheduler:** Sistem *cron job* yang membatalkan pesanan otomatis jika pengguna tidak membayar dalam batas waktu (misal: 15 menit), dan mengembalikan kursi menjadi *Available*.

---

## 🛠️ Teknologi yang Digunakan (Tech Stack)

* **Front-end:** [Isi dengan framework pilihan, misal: React / Vue / Laravel Blade]
* **Back-end:** [Isi dengan framework pilihan, misal: Node.js / Express / Laravel / Java]
* **Database:** [Isi dengan database pilihan, misal: MySQL / PostgreSQL]
* **Integrasi:** [Nama Payment Gateway Sandbox, misal: Midtrans / Xendit]
...
### Prasyarat Instalasi
* Node.js / Composer / PHP (Sesuaikan)
