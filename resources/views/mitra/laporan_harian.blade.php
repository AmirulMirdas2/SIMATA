...
<div class="bg-white p-6 md:p-8 rounded-lg shadow-md mb-8">
    <div class="flex justify-between items-center border-b pb-4 mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Laporan Keuangan Harian</h2>
            <p class="text-gray-600 mt-1">PO {{ $poBus->nama_po }}</p>
        </div>
        <div class="text-4xl text-blue-500 opacity-50"><i class="fas fa-chart-line"></i></div>
    </div>

    <!-- Filter Section -->
    <form method="GET" action="{{ route('mitra.laporan.harian') }}" class="flex flex-col md:flex-row items-end gap-4 bg-gray-50 p-6 rounded-lg border border-gray-200">
        <div class="w-full md:w-1/3">
            <label class="block text-gray-700 text-sm font-bold mb-2">Pilih Tanggal Transaksi</label>
            <div class="relative">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="5" class="p-4 text-center text-gray-500 py-8">
                        ...
                        Anda tidak memiliki transaksi yang lunas pada tanggal ini.
                    </td>
                </tr>
                @endforelse
            </tbody>
